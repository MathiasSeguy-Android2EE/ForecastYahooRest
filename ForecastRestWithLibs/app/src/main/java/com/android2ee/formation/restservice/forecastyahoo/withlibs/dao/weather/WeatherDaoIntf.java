/**
 * <ul>
 * <li>WeatherDaoIntf</li>
 * <li>com.android2ee.formation.restservice.forecastyahoo.withlibs.dao.weather</li>
 * <li>10/04/2016</li>
 * <p/>
 * <li>======================================================</li>
 * <p/>
 ...
 */
public interface WeatherDaoIntf {
    /**
     * The find by cityId
     * @param cityId
     * @return
     ...
     * @return
     */
    long insertOrUpdate(Weather weather);
