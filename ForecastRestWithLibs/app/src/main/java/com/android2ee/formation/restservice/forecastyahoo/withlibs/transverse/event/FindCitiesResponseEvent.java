...
public class FindCitiesResponseEvent {
    ...
    public FindCitiesResponseEvent(FindCitiesResponse findCitiesResponse) {
        this.findCitiesResponse = findCitiesResponse;
    }

    public FindCitiesResponse getFindCitiesResponse() {
        return findCitiesResponse;
    }

    public void setFindCitiesResponse(FindCitiesResponse findCitiesResponse) {
        this.findCitiesResponse = findCitiesResponse;
    }
}
