...
import com.android2ee.formation.restservice.sax.forecastyahoo.withlibs.com.noconnectivity.NoConnectivityDataCommunication;
...
public class DataCommunication implements DataCommunicationIntf{
    ...
    @Override
    public com.android2ee.formation.restservice.sax.forecastyahoo.withlibs.transverse.model.current.FindCitiesResponse getCitiesByName(String cityName) {
